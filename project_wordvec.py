...
glove_file = "/home/surisr/glove.6B.300d.txt"
tmp_file = "/home/surisr/glove_w2vec.txt"
...
class Classifiers:
        ...
        for file in f_airlines:
            ...
            for tweet in tweets:
                ...
                if ( self.features.isTweetReply(tweet['text']) == False): # and self.features.isTweetFromAirline(tweet, airline_handle) == False ):
                    self.features.addTweet ( tweet['text']  ,wordvec = True) 
                    i=i+1
    ...
    def runClassifiers(self):
            ...
            grd = GradientBoostingClassifier(n_estimators=100,max_depth=5,random_state=42)
